...
max_hit = 66
def new_bandit(step):
    global myProbabs, his_low_chances, kExp
    ...
    if last_reward == 1:
        return last_bandit
    if n_last_move >= 2 and myProbabs[his_last_bandit] > 0.2 and (my_hits[his_last_bandit]+his_hits[his_last_bandit]) < max_hit:
    ...
    if step < 1998:
         scores[my_record[step-2:step]] = -2
